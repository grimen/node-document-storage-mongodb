...
module.exports = {
  get: function(db, type, id, callback) {
    ...
    var client = new mongodb.Db(db, new require('mongodb').Server('localhost', 27017), {safe: false});
  ...
  set: function(db, type, id, data, callback) {
    ...
    var client = new mongodb.Db(db, new mongodb.Server('localhost', 27017), {safe: false});
